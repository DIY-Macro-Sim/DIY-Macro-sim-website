...
The following code covers some basic *R* operations.^[Some of the material below is taken from [here](https://www.w3schools.com/r/default.asp).]. If you are new to *R* and are keen to get started, do the following:
